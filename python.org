         ...
         (if (array-type? type)
             (let ((base-type (array-base-type type)))
               (case base-type
                 ...
                 ((long)
                  (string-append
                   (indent-line (+ indent 2) "var alsize: int = len(" accessor ") << 3")
               ...
               (case base-type
                 ...
                 ((short)
                  (string-append
                   ...
                   (indent-line (+ indent 4) accessor ".append(int.from_bytes(buf[offset + (j << 1): offset + ((j + 1) << 1)], 'big', True))")
                 ...
                 ((int)
                  (string-append
                   ...
                   (indent-line (+ indent 4) accessor ".append(int.from_bytes(buf[offset + (j << 2): offset + ((j + 1) << 2)], 'big', True))")
                   (indent-line (+ indent 2) "offset += size")))
                 ((long)
                  (string-append
                   (indent-line (+ indent 2) "size = int.from_bytes(buf[offset : offset + 4], 'big')")
                   ...
                   (indent-line (+ indent 4) accessor ".append(int.from_bytes(buf[offset + (j << 3): offset + ((j + 1) << 3)], 'big', True))")
                   (indent-line (+ indent 2) "offset += size")))
                 ((string)
                  (string-append
                   (indent-line (+ indent 2) "size = int.from_bytes(buf[offset : offset + 4], 'big')")
