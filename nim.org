        ...
        (string-append
         ...
         (if (primitive-type? type)
             (string-append
              ...
              (indent-line (+ indent 6) "dtags[dlen] = 1")
  ...
  (define (generate-nim-decoder sname fields)
    (let ((vsname (>nim-token sname))
      ...
      (string-append
       ...
       (indent-line 2 "var")
       (indent-line 4 vsname ": ref " tname)
       (indent-line 4 "dtags: array[0.." (number->string (- (length fields) 1)) ", int]")
       (indent-line 4 "dlen: int = 0")
       (indent-line 2 "new(" vsname ")")
       (indent-line 2 "var ptr0: int = parse_fields(buf, start, " vsname ", dtags, dlen)")
       (indent-line 2 "discard parse_data(buf,  ptr0, " vsname ", dtags, dlen)")
...
#+begin_src scheme :exports code :noweb yes :tangle /dev/shm/tightrope-build/nim.scm
  ...
  proc zeropack*(src: seq[byte]): seq[byte] =
    var
      dst: seq[byte] = newSeq[byte](len(src))
      ffcnt: byte = 0
      ffpos: int = 0
      oocnt: byte = 0
      oopos: int = 0
  ...
  proc unzeropack*(src: seq[byte]): seq[byte] =
    var
      slen: int = len(src)
      dst: seq[byte] = newSeq[byte](slen * cast[int](src[0]))
      sptr: int = 1
      dptr: int = 0
      cnt: int = 0
    while sptr < slen:
